...
struct OthelloState {
    ...
    // TODO: set initial stones
    uint64_t board[2] = {
        0b000000000000001000000100000000000000ull, 
    ...
    bool apply_move(uint64_t index) {    
        ...
        auto to_flip = OthelloDumb7Fill6x6::to_flip(mask(index), board[player], board[1 - player]);
