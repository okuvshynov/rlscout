...
template <typename State, typename score_t, int32_t log_max_level = 11, int32_t canonical_max_level = 28, int32_t evaluate_nn_until_level = 20, int32_t sample_nn_until_level = 0>
class AlphaBeta {
